...
4. Read the descriptions for `map`, `find`, and `find_all` in the [Ruby Docs Enumerables Page](https://ruby-doc.org/core-2.4.0/Enumerable.html). How are these descriptions similar/different to your answers to the first 3 questions?
...
All the other enumerables have a do block; these don't but are still considered enumerables - why?
...
We'll often times want to sort the data we have.
